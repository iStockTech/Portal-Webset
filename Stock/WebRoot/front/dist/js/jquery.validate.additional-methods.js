...
// 验证身份证号
$.validator.addMethod("idNumber",function(idNumber,element){
...
//	console.log("idNumber = "+idNumber);
	...
	if (len == 15){
		...
		var arrSplit = idNumber.match(re);
		//检查生日日期是否正确
...
// 验证中文姓名
$.validator.addMethod("chineseName",function(chineseName,element){
	chineseName = chineseName.replace(/\s+/g, "");
	return this.optional(element) || true &&
	chineseName.match(/[\u4e00-\u9fa5]{2,}/);
},"中文姓名输入错误");