...
<nav class="nav navbar-inverse" role="navigation">
	<div class="container">
		<div class="navbar-header">
			<a class="navbar-brand nav-logo" href="../index.jsp"></a>
		</div>
		<div class="collapse navbar-collapse">
			...
			<div id="account-bar" class="collapse navbar-collapse text-right">
				<ul class="nav navbar-nav" style="float: right;border-left: 2px solid black;height: 50px;">
					<li class='${param.index=="account"?"active":"" }'><a href="../account.jsp">登录</a></li>
					<li class='${param.index=="account"?"active":"" }'><a href="../signup.jsp">注册</a></li>
					<li class='${param.index=="account"?"active":"" }'><a href="../account.jsp">忘记密码</a></li>
				</ul>
			</div>	
		</div>			
	</div>
