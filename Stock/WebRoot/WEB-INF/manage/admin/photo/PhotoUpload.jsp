...
<!-- 
	<form id="form1" action="Image_upload" method="post" enctype="multipart/form-data">
		...
		<input id="btnUpload" type="submit" value="上传图片" class="btn" />
 ...
 -->
	<s:form action="Image_upload" method="post" enctype="multipart/form-data">
		<s:file name="file" label="选择文件"/><br>
		<s:textfield name="newsInfoId" label="新闻id"/><br>
		<s:textfield name="imageDescript" label="图片描述" /><br>
